...
// import imgJumbotron from './../assets/images/monochrome/Winners_Monochromatic.png';
                    ...
                    <div className="col-xl-4 col-xl-4 col-md-4 col-sm-12">
                        <div className="card border-light mb-3">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Gamification engine give you access to create and manage missions, badges and levels for your players.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-4 col-xl-4 col-md-4 col-sm-12">
                        <div className="card border-light mb-3">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">Connect to the gamification system easily and quickly. Set up your own micro-service or use our API.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-4 col-xl-4 col-md-4 col-sm-12">
                        <div className="card border-light mb-3">
                            ...
                            <div className="card-body">
                                ...
                                <p className="card-text">The project started in February 2022. The first milestone is the API and demo application launch. Stay up to date and share your feedback with us.</p>
                            </div>
                        </div>
                    </div>
            ...
            <section className='container mt-5'>
                <div className="row">
                    <div className="col-xl-8 col-lg-8 col-sm-12">
                        ...
                        <p>It easy! First download code from <a href='https://github.com/dyzio18/selfcodehero' target="_blank">repository</a>. Make sure you have installed Node.js and NPM (or Yarn).</p>
